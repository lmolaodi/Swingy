...
public class Map extends PlayerCharacter{
    ...
    public Map(Hero hero) {
        ...
        this.hero = hero;
        map = new PlayerCharacter[size][size];
    ...
    public void displayMap() {
        for (int y = 0; y < size; ++y) {
            for (int x = 0; x < size; ++x) {
                ...
                System.out.print(map[y][x].getPlayerName());
            }
            System.out.println();
        }
    }
    ...
    public boolean battle() {
        ...
        PlayerCharacter villain = map[hero.getY()][hero.getX()];
    ...
    private boolean fight(PlayerCharacter hero, PlayerCharacter villain) {
        int attack;
...
//                System.out.println("V HP: " + villainHitPoints + "\n");
    ...
    private boolean run(PlayerCharacter hero, PlayerCharacter villain) {
    ...
    public PlayerCharacter getCharacter(int y, int x) {
        return (map[y][x]);
    }
